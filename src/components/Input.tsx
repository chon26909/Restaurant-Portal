    ...
    return (
        <div className={[full ? 'w-full' : 'inline-block', ' mt-2 mr-3'].join(' ')}>
            ...
            <input
                {...other}
                type='text'
                className={[full ? 'w-full' : 'w-[250px]', errorMessage && errorMessage.length > 0 ? '!border-red ring-1 ring-red' : 'focus:border-primary focus:ring-1 ring-primary', inputClass].join(
                    ' '
                )}
            />
